        ...
        <>
            <section className="fact-table">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td className="double-span" rowspan="4" colspan="2">Terrestial Planets</td>
                            <td>Mercury</td>
                            <td>0.330</td>
                            <td>4,878</td>
                            <td>5427</td>
                        ...
                        <tr>
                            <td className="double-span" rowspan="4">Jovian Planets</td>
                            <td className="double-span" rowspan="2">Gas Giants</td>
                            <td>Jupiter</td>
                            <td>0.330</td>
                            <td>4,878</td>
                            <td>5427</td>
                        ...
                        <tr>
                            <td className="double-span" rowspan="2">Ice Giants</td>
                            <td>Uranius</td>
                            <td>0.330</td>
                            <td>4,878</td>
                            <td>5427</td>
